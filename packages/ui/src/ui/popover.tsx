...
export function usePopover(component = "Popover subcomponent") {
...
export function usePopoverContext() {
  return usePopover("usePopoverContext")
}
...
export const Popover: PopoverComponent = ({
  ...
  const close = useCallback(() => {
    ...
    tl.to(trigger, { opacity: 1, duration: 0.1, ease: "power2.out" }, "-=0.05")
  }, [isOpen, onClose])
...
export function PopoverTrigger({
  ...
  const { isOpen, open, triggerRef, triggerId, contentId } =
  ...
  return cloneElement(child as ReactElement<Record<string, unknown>>, {
    ...
    ref: (node: HTMLElement | null) => {
      ...
      const existingRef = (child as unknown as { ref?: React.Ref<HTMLElement> })
        .ref
...
export function PopoverContent({
  ...
  const { isOpen, close, containerRef, backdropRef, contentRef, contentId } =
